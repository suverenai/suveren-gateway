...
#
# The toast command is GENERATED from apps/control-plane/src/lib/desktop-notify.ts
# (buildNotifyCommand) — the exact string the gateway spawns, not a re-implementation.
# Regenerate after changing the builder.
#
# Expected: toast with Suveren icon + default notification sound; clicking opens
# the browser; it stays in Action Center; "Suveren" appears in Settings ->
